              ...
              child: Wrap(
                children: [
                  Container(
                    child:RichText(
                      text: TextSpan(children: [
                        sousTitre("Aussi à l'aise à la récupération grâce à sa fougue, à la relance avec son énergie ou en meneur de jeu avec sa créativité et sa vision stratégique, ses expériences de la gestion de projet, de la mobilisation citoyenne et du développement du pouvoir d'agir dans différents mouvements d'éducation populaire, lui permettent d'avoir de nombreuses cartes de son jeu. "),
                      ]),
                    ),),
                ],),),
      //images
            ...
            Padding(
              ...
              child:
              legendePictures("Photographie prise après une manifestation pacifique de libération des poulets du monde et contre l'oppression animale"),
            ),
            Padding(padding: EdgeInsets.only(top:12, left:20, right:30),
            child:
                ...
                child: Wrap(
                  children: [
                    Container(
                      child:RichText(
                        text: TextSpan(children: [
                          sousTitre("Née en Union Soviétique qu'elle connaîtra près d'une décennie avant sa chute, elle a passé une adolescence agitée dans la toute neuve Russie vendue au capitalisme par Gorbatchev."),
                        ]),
                      ),),
                  ],),),
              //images
